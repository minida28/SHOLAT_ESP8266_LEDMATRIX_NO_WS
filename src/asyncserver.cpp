...
bool loadHTTPAuth()
{
  ...
  _httpAuth.auth = root["auth"];
  strlcpy(_httpAuth.wwwUsername, root["user"], sizeof(_httpAuth.wwwUsername));
  strlcpy(_httpAuth.wwwPassword, root["pass"], sizeof(_httpAuth.wwwPassword));
