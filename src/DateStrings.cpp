...
const int NUMBER_OF_MONTH_ELEMENTS = 13;

const char *const monthNames_P[NUMBER_OF_MONTH_ELEMENTS] PROGMEM =
    {
        monthStr0, monthStr1, monthStr2, monthStr3, monthStr4, monthStr5, monthStr6,
        monthStr7, monthStr8, monthStr9, monthStr10, monthStr11, monthStr12};
...
const int NUMBER_OF_DAY_ELEMENTS = 7;

const char *const dayNames_P[NUMBER_OF_DAY_ELEMENTS] PROGMEM =
    {
